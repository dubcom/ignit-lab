...
import { IconTelescope } from "../components/icon-telescope";
  ...
  return (
    <>
      <Container flex='column' margin={pixelToRem(24, 112, 50)}>
        ...
        <Main>
          <FirstTitle>Sim, é possível!</FirstTitle>

          <SecondTitle>Sua jornada para o candidato de sucesso começa aqui <span>.</span></SecondTitle>

          <Subtitle>A primeira o a atual candidatura passa pelas mesmas necessidades de organização. Inscreva-se em nossa lista de espera dicas para ter sucesso.
          </Subtitle>
